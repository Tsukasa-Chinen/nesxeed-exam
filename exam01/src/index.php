<?php
	...
	if(!empty($_POST)){
		...
		$checkEmail = db_user_email($loginEmail);

		$loginPassword = $_POST['login_password'];
		$checkPassword = db_user_password($loginPassword);
...
<body>
	<form class="form login" action="" method="post">
		<h1 class="exam_logo">THE EXAM</h1>
		...
		<div class="btn_area">
			<p><input class="btn go" type="submit" value="ログイン"></p>
		</div>
	</form>
</body>
</html>